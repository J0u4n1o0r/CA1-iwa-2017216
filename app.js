//Referencing: Same code given in class by mikhail
...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('HelloWorld.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('HelloWorld.xsl', 'utf8'); //We are reading in the XSL file
...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    xmlFileToJs('HelloWorld.xml', function(err, result) {
      if (err) throw (err);
      ...
      jsToXmlFile('HelloWorld.xml', result, function(err) {
